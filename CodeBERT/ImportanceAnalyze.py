...
def main():
    ...
    parser.add_argument("--source_codes_path", default="dataset/Devignn/test1.jsonl", type=str, help="Path to test data.")
    parser.add_argument("--tokens_list_path", default="GraphCodeBERT/tokens.json", type=str, help="Path to tokens file.")
    parser.add_argument("--tokens_scores_path", default="GraphCodeBERT/token_grad_norms.npz", type=str, help="Path to scores file.")
    ...
    assess_functions = [
        ...
        if name.startswith('Assess') and inspect.isfunction(func) and func.__module__ == 'Java_FindTransformations'
    ]
    ...
    for source_code_info in tqdm(source_codes, desc="Analyzing Transformations"):
        ...
        root_node = generateASt(current_code, 'java')
